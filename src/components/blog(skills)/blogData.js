...
export const blogData = {
    ...
    athletics: 'I love being active. As of now, I currently training for the Toronto Waterfront Marathon in October 2023. I also enjoy other sports such as snowboarding.',
